...
public class TravelArticle {
    ...
    @Builder
    public TravelArticle(Long id, String title, String content, String email, LocalDateTime createDate, LocalDateTime updateDate, String deleteYn, int viewCount, String boardCode, MemberInfo memberInfo) {
        this.id = id;
        this.title = title;
